...
add dst-address=10.100.100.10 protocol=tcp dst-port=3000 action=accept comment="Bypass Portal Port 3000"
add dst-address=10.100.100.10 protocol=tcp dst-port=80 action=accept comment="Bypass Portal Port 80"
