...
#   - Mini PC Server (ether2)           : 10.100.254.190
#   - Gateway Hotspot & Router API      : 10.100.0.1 (Port 8728)
# =============================================================================
...
/ip hotspot profile
add name=hsprof-captive hotspot-address=10.100.0.1 dns-name=hotspot.net login-by=http-chap,http-pap html-directory=hotspot http-cookie-lifetime=3d split-user-domain=no use-radius=no
...
add server=hotspot1 dst-host=10.100.254.190 comment="IP Mini PC"

/ip hotspot walled-garden ip
add dst-address=10.100.254.190 dst-port=3000 action=accept comment="Web Portal SIPAS Port 3000"
add dst-address=10.100.254.190 dst-port=80 action=accept comment="Web Portal SIPAS Port 80"
add dst-address=10.100.254.190 action=accept comment="Bypass Traffic Mini PC"
...
add name=sipas.local address=10.100.254.190 comment="Domain Lokal Mini PC"
