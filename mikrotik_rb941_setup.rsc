# =============================================================================
#     MIKROTIK SIPAS LOCAL SETUP (KHUSUS RB941-2nD / hAP lite / 4-PORT)
# =============================================================================
# Perangkat : Mikrotik RB941-2nD (4 Port Ethernet + Wi-Fi Internal wlan1)
# Topologi:
...
#   - ether3, ether4, wlan1 : Client Hotspot / Wi-Fi (Subnet: 10.10.0.0/16)
...
# --- LANGKAH 2: Bridge Hotspot KHUSUS Client (ether3, ether4, wlan1) ---
/interface bridge
add name=bridge-hotspot comment="Bridge Hotspot Klien (ether3, ether4, wlan1)"
...
/system identity
set name=SIPAS-Mikrotik-RB941

:log info "Konfigurasi Mikrotik RB941-2nD (4-Port + Wi-Fi) berhasil dipasang!"
