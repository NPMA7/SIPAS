...
export default function PortalLogin() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setTimeout(() => {
          ...
          if (
            ...
            rawDst.includes("sipas.hostpot.net") ||
          ...
          // Langsung arahkan browser ke target URL (https://www.google.com) tanpa POST ke sipas.hostpot.net agar tidak memicu layar peringatan "Dangerous site" Chrome.
        ...
        setAlert({
          type: "error",
          msg: data.message || "Login gagal. Periksa username dan password.",
        });
        setLoading(false);
      }
    } catch (err) {
      ...
      setAlert({
        type: "error",
        msg: "Tidak dapat terhubung ke server portal.",
      });
      setLoading(false);
    }
  }
      ...
      <div style={styles.wrapper}>
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>
            Portal <span style={{ color: "var(--primary-light)" }}>SIPAS</span>
          </h1>
...
const styles = {
  ...
  bg: {
    ...
    zIndex: 0,
    background:
      "radial-gradient(ellipse at 20% 50%, rgba(99,102,241,0.08) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(6,182,212,0.06) 0%, transparent 50%)",
  },
  orb1: {
    position: "fixed",
    top: "-15%",
